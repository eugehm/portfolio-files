...
[InitializeOnLoad]
class ArborCoroutineManagerSetup
{
    ...
    static ArborCoroutineManagerSetup()
    {
        RegisterModuleDefine("ARBOR_COROUTINE_MANAGER");
        EditorApplication.update += EditorUpdate;
    }

    static void EditorUpdate()
    {
        EnforcePrefabExistsInScene("_ArborCoroutineManager");
    }
