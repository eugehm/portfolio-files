...
[InitializeOnLoad]
class QualitySettingsManagerSetup
{
    ...
    static QualitySettingsManagerSetup()
    {
        RegisterModuleDefine("QUALITY_SETTINGS_MANAGER");
        EditorApplication.update += EditorUpdate;
    }

    static void EditorUpdate()
    {
        EnforcePrefabExistsInScene("QualitySettingsManager");
    }
